...
def count_dollars(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def count_ways(total, largest_bill):
        if total == 0:
            return 1
        ...
        elif largest_bill is None:
            return 0

        else:
            return count_ways(total - largest_bill, largest_bill) + count_ways(total, next_smaller_dollar(largest_bill))
...
def count_dollars_upward(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def count_ways(total, smallest_bill):
        ...
        elif smallest_bill == None:
            return 0
        else:
            return count_ways(total - smallest_bill, smallest_bill) + count_ways(total, next_larger_dollar(smallest_bill))
