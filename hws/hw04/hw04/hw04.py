...
def balanced(m):
    ...
    if is_mobile(m):
        ...
        is_equal_torque = (left_len * left_mass) == (right_len * right_mass)
        is_ends_balanced = balanced(end(left(m))) and balanced(end(right(m)))
        return is_equal_torque and is_ends_balanced
